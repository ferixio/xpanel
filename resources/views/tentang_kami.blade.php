...
@section('content')
  ...
  <section class="uk-container uk-margin-large uk-padding uk-text-center" style="white-space: pre-wrap">
   <h3 class="uk-text-bold">Selamat datang di <br> Sugar Pastry Brownies</h3>
Sugar Pastry Brownies, dari Bandung untuk Nusantara Kota Bandung dikenal sebagai kota wisata. Meski tak memiliki objek wisata alam, namun kota berjuluk Paris Van Java ini tetap memiliki daya tarik bagi para pelancong. Salah satu daya tarik tersebut adalah wisata kulinernya. Wisatawan yang bertandang ke kota kembang ini tentu tak akan melewatkan membeli oleh-oleh makanan. Salah satu buah tangan yang paling favorit ditenteng wisatawan saat pulang adalah produk Sugar Pastry Brownies.
