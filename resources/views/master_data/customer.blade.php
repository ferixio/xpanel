@extends('layouts.app')
@section('content')
  <h5 class="title uk-text-uppercase uk-text-left@l uk-text-center">Data Customer</h5>
     ...
     @for ($i = 1; $i < 6; $i++)
       <div>
          <div class="x-grid-item uk-box-shadow-small x-list uk-flex uk-flex-middle  uk-transition-toggle" tabindex="0">
            <div>
              <img uk-img data-src="{{asset('/img/team.svg')}}" style="width: 64px; height:64px;" class="x-margin-auto" />
            </div>
            <div class="x-grid-desc uk-margin-medium-left  uk-width-expand">
              <h5 class="uk-text-uppercase uk-margin-remove ">Customer {{ $i}}</h5>
       ...
       <form class="uk-form-stacked">
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Nama Customer</label>
             <input type="text" class="uk-input" placeholder="masukan nama customer">
           </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Alamat</label>
            <input type="text" class="uk-input" placeholder="masukan alamat customer">
          </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
