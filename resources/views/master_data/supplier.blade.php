@extends('layouts.app')
@section('content')
  <h5 class="title uk-text-uppercase uk-text-left@l uk-text-center">Data Supplier</h5>
     ...
     @for ($i = 1; $i < 6; $i++)
       <div>
          <div class="x-grid-item uk-box-shadow-small x-list uk-flex uk-flex-middle  uk-transition-toggle" tabindex="0">
            <div>
              <img uk-img data-src="{{asset('/img/market.svg')}}" style="width: 64px; height:64px;" class="x-margin-auto" />
            </div>
            <div class="x-grid-desc uk-margin-medium-left  uk-width-expand">
              <h5 class="uk-text-uppercase uk-margin-remove ">Supplier {{ $i}}</h5>
       ...
       <form class="uk-form-stacked">
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Nama Supplier</label>
             <input type="text" class="uk-input" placeholder="masukan nama Supplier">
           </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Alamat</label>
            <input type="text" class="uk-input" placeholder="masukan alamat Supplier">
          </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Handphone</label>
            <input type="text" class="uk-input" placeholder="masukan nomor handphone">
          </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
