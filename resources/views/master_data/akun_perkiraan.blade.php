@extends('layouts.app')
@section('content')
  <h5 class="title uk-text-uppercase uk-text-left@l uk-text-center">Akun Perkiraan</h5>
  ...
  <div id="x-grid" class="uk-flex uk-child-width-1-1 uk-grid-small uk-padding uk-grid-match" uk-grid>
       ...
       <div>
          <div class="x-grid-item uk-box-shadow-small x-list uk-flex uk-flex-middle  uk-transition-toggle" tabindex="0">
            <div class="x-grid-desc uk-margin-medium-left  uk-width-expand">
              <h5 class="uk-text-uppercase uk-margin-remove ">Kas</h5>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Kode Akun : 100</p>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Posisi Normal : Debet</p>
            </div>
       ...
       <div>
          <div class="x-grid-item uk-box-shadow-small x-list uk-flex uk-flex-middle  uk-transition-toggle" tabindex="0">
            <div class="x-grid-desc uk-margin-medium-left  uk-width-expand">
              <h5 class="uk-text-uppercase uk-margin-remove ">Hutang</h5>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Kode Akun : 200</p>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Posisi Normal : Kredit</p>
            </div>
       ...
       <div>
          <div class="x-grid-item uk-box-shadow-small x-list uk-flex uk-flex-middle  uk-transition-toggle" tabindex="0">
            <div class="x-grid-desc uk-margin-medium-left  uk-width-expand">
              <h5 class="uk-text-uppercase uk-margin-remove ">Modal</h5>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Kode Akun : 300</p>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Posisi Normal : Kredit</p>
            </div>
       ...
       <div>
          <div class="x-grid-item uk-box-shadow-small x-list uk-flex uk-flex-middle  uk-transition-toggle" tabindex="0">
            <div class="x-grid-desc uk-margin-medium-left  uk-width-expand">
              <h5 class="uk-text-uppercase uk-margin-remove ">Pendapatan</h5>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Kode Akun : 400</p>
              <p class="uk-text-meta x-font-12 uk-margin-remove"> Posisi Normal : Kredit</p>
            </div>
       ...
       <form class="uk-form-stacked">
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Nama Akun Perkiraan</label>
             <input type="text" class="uk-input" placeholder="masukan nama akun perkiraan">
           </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Kode Akun</label>
            <input type="text" class="uk-input" placeholder="masukan kode akun">
          </div>
         </div>
         <div class="uk-margin">
           <div class="uk-form-controls">
            <label class="uk-form-label">Posisi Normal</label>
            
            <select name="posisi-normal" id="posisi-normal" class="uk-select">
